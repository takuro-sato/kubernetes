...
var _ = SIGDescribe("[Feature:HPA] Horizontal pod autoscaling (scale resource: CPU)", func() {
	...
	ginkgo.Describe("[Serial] [Slow] Deployment (Pod Resource)", ginkgo.Ordered, func() {
	...
	ginkgo.Describe("[Serial] [Slow] Deployment (Container Resource)", ginkgo.Ordered, func() {
		ginkgo.It(titleUp+titleAverageUtilization, func(ctx context.Context) {
	...
	ginkgo.Describe("[Serial] [Slow] ReplicaSet", ginkgo.Ordered, func() {
	...
	ginkgo.Describe("[Serial] [Slow] ReplicationController", ginkgo.Ordered, func() {
	...
	ginkgo.Describe("ReplicationController light", ginkgo.Ordered, func() {
	...
	ginkgo.Describe("[Serial] [Slow] ReplicaSet with idle sidecar (ContainerResource use case)", ginkgo.Ordered, func() {
	...
	ginkgo.Describe("CustomResourceDefinition", ginkgo.Ordered, func() {
