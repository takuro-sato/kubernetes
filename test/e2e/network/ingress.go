...
var _ = common.SIGDescribe("Loadbalancing: L7", func() {
	...
	ginkgo.Describe("GCE [Slow] [Feature:Ingress]", ginkgo.Ordered, ginkgo.ContinueOnFailure, func() {
	...
	ginkgo.Describe("GCE [Slow] [Feature:NEG]", ginkgo.Ordered, ginkgo.ContinueOnFailure, func() {
		var gceController *gce.IngressController
