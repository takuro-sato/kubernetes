...
var _ = SIGDescribe("Kubectl logs", func() {
	...
	ginkgo.Describe("logs", ginkgo.Ordered, ginkgo.ContinueOnFailure, func() {
	...
	ginkgo.Describe("default container logs", ginkgo.Ordered, ginkgo.ContinueOnFailure, func() {
		ginkgo.Describe("the second container is the default-container by annotation", ginkgo.Ordered, ginkgo.ContinueOnFailure, func() {
			var pod *v1.Pod
