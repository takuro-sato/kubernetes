...
var _ = SIGDescribe("Pods Extended", func() {
	...
	ginkgo.Describe("Delete Grace Period", ginkgo.Ordered, ginkgo.ContinueOnFailure, func() {
	...
	ginkgo.Describe("Pods Set QOS Class", ginkgo.Ordered, ginkgo.ContinueOnFailure, func() {
		var podClient *e2epod.PodClient
		ginkgo.BeforeEach(func() {
			podClient = e2epod.NewPodClient(f)
		})
	...
	ginkgo.Describe("Pod Container Status", ginkgo.Ordered, ginkgo.ContinueOnFailure, func() {
		var podClient *e2epod.PodClient
		ginkgo.BeforeEach(func() {
			podClient = e2epod.NewPodClient(f)
		})
	...
	ginkgo.Describe("Pod Container lifecycle", ginkgo.Ordered, ginkgo.ContinueOnFailure, func() {
		var podClient *e2epod.PodClient
		ginkgo.BeforeEach(func() {
			podClient = e2epod.NewPodClient(f)
		})
	...
	ginkgo.Describe("Pod TerminationGracePeriodSeconds is negative", ginkgo.Ordered, ginkgo.ContinueOnFailure, func() {
		var podClient *e2epod.PodClient
		ginkgo.BeforeEach(func() {
			podClient = e2epod.NewPodClient(f)
		})
