...
var _ = SIGDescribe("[Feature:Example]", func() {
	...
	ginkgo.Describe("Liveness", ginkgo.Ordered, ginkgo.ContinueOnFailure, func() {
	...
	ginkgo.Describe("Secret", ginkgo.Ordered, ginkgo.ContinueOnFailure, func() {
	...
	ginkgo.Describe("Downward API", ginkgo.Ordered, ginkgo.ContinueOnFailure, func() {
